...
function ex11() {
    ...
    for (let j = 1; j < listaNotas.length; j++) {
        if (listaNotas[j] < 60) {
            console.log(`o aluno ${j} foi reprovado, teve média de ${listaNotas[j]}.`);
        }
        else {
